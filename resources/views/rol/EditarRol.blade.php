...
<div class="d-flex justify-content-between flex-wrap flex-md-nowrap align-items-center pt-3 pb-2 mb-3 border-bottom">
    <h1 class="h2">Editar usuario: {{ $rol->nom_rol }}</h1>
</div>
<div class="container">
    <div class="row justify-content-center">
        <div class="col-md-12">
        @include('errorMessagesPartial')
        {!! Form::model($rol, ['route' => ['editar-rol-guardar', $rol->id], 'method' => 'PUT']) !!}
        ...
        <div class="form-group">
            ...
            {!! Form::text('desc_rol', $rol->desc_rol, ['class' => 'form-control', 'placeholder' => 'Descripción del rol']) !!}
        </div>
        <div class="form-group">
