...
class Client
{
    public const DEFAULT_URI = 'mongodb+srv://admin:admin@clustercursojava.dasxz.mongodb.net/test?authSource=admin&replicaSet=atlas-8ytpsk-shard-0&readPreference=primary&appname=MongoDB%20Compass&ssl=true';
